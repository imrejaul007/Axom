 ...
 */
export declare enum TwinCapability {
...
export declare const TWIN_SCHEMA_VERSION = "1.0.0";
/** Initial learning progress percentage for a newly created twin. */
export declare const INITIAL_LEARNING_PROGRESS = 0;
/** Initial data point count for a newly created twin. */
export declare const INITIAL_DATA_POINTS = 0;
